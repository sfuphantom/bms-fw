...
// FreeRTOS variables
//TimerHandle_t imdFRC;
uint32_t expiredCounter;
...
void initalizeIMD(){
    ...
    //Source for xTimerCreate: https://www.freertos.org/FreeRTOS-timers-xTimerCreate.html
    //imdFRC = xTimerCreate("IMD_timer", pdMS_TO_TICKS(1000), pdTRUE, (void *)expiredCounter, vTimerCallback);  //Create the software timer
    //xTimerStart(imdFRC);
}

/*
 * Fn: vTimerCallback
 * Purpose: Counts the number of times imdFRC expires and updates expiredCounter.
 * This function may need to be used in place of edgeNotification
 */
//void vTimerCallback(TimerHande_t xTimer){
//    expiredCounter++;
//    vTimerSetTimerID(imdFRC, (void *)expiredCounter);
//}
...
void edgeNotification(hetBASE_t * hetREG,uint32 edge)
{
    ...
    if(hetREG == hetREG1 && edge == 0)
    {
        ...
        if(pinStatus == 1) time1 = xTaskGetTickCount();
